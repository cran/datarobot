...
#'   \item{autopilotMode}{Numeric: 0 for fully automatic mode; 1 for semi-automatic mode; 2 for manual mode}
...
#'   \item{partition}{A 7-element list describing the data partitioning for model fitting and cross validation}
...
#'   \item{holdoutUnlocked}{A logical flag indicating whether the holdout dataset has been used for model evaluation}
#'   \item{targetType}{Character string specifying the type of modeling problem (e.g., regression or binary classification)}
#' }
#' @export
#'
