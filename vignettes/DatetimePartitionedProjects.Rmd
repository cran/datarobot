...
Let's look at how we would frame a problem with a time component
 ...
 within DataRobot. We will use a sample dataset from LendingClub, similar to the ReasonCodes Vignette. We want to train the model on historical loans and validate on recent loans and would therefore like to use
